...
Rand_Dict = dict[str, PRNGKeyArray]
...
class BasicTrainer:
    ...
    def fit(self, train_data: Data, val_data: Data = None, num_epochs: int = 1, log_freq: int = 1):
        """
        ...
        :param log_freq: frequency to print epoch metrics
        :return:
        """
        ...
        for e in range(self.num_epochs):
            ...
            # logging.debug("Epoch: %d - %s", e, duration)
            duration = time.monotonic() - epoch_start_time
            nl_d = seconds_pretty(duration)
